...
/**
 * Escribe un método en una clase llamada OperacionesArrayList que reciba un ArrayList de cadenas y devuelva la cantidad 
 * de elementos que comienzan con la letra 'A'. a la lista.
 * @author ElliotDAM
 */
