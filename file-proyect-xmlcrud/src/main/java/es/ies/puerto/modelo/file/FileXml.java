...
//Metodo para ahorrar espacio en los distintos metodos, ya que el add, update y delete se utilizan la misma estructura para modificar
//los datos dentro del fichero
