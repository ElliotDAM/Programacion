...
public class ConfigProyectoTest {
    final String MESSAGE_ERROR ="No se ha obtenido el valor esperoado";
    AppConfig configProyecto;

    @BeforeEach
    public void beforeEach() {
        configProyecto = new AppConfig();
    }

    @Test
    public void getPropertiesTest() {
        Assertions.assertNotNull(configProyecto.bundle,
                MESSAGE_ERROR);
        Assertions.assertNotNull(configProyecto.bundle.keySet(),
                MESSAGE_ERROR);
    }

    @Test
    public void greetingTest() {
        Assertions.assertNotNull(configProyecto.bundle.getObject("greeting"),
                MESSAGE_ERROR);
    }

    @Test
    public void farewellTest() {
        Assertions.assertNotNull(configProyecto.bundle.getObject("farewell"),
                MESSAGE_ERROR);
    }
